...
function showRandomArticle() {
  ...
  const item = data[randomCountry]
    ...
    <div rel="noopener noreferrer" class="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-50">
      ...
      <div class="p-6 space-y-2 lg:col-span-5">
        ...
        item.borders
        .map(item => `<a class="p-2 inline-block rounded-[15px] bg-indigo-300 hover:scale-110">${item}</a>
        `)
        .join(' ')}
        </p>
